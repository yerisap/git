					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제 E08",
									"targetURL": "#synce08ex3-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce08ex3-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.ex3",
									"url": sap.ui.require.toUrl("sync/e08/ex3")
								}
							}
						}
					}
