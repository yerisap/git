		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce08odatamodlemultiupdate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce08odatamodlemultiupdate-display": {
								"semanticObject": "synce08odatamodlemultiupdate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.odatamodlemultiupdate",
									"url": sap.ui.require.toUrl("sync/e08/odatamodlemultiupdate")
								}
							}
						}
					}
