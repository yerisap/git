		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce08exercise11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce08exercise11-display": {
								"semanticObject": "synce08exercise11",
								"action": "display",
								"description": "항공사와 항공편 조",
								"title": "Use Element Binding &amp; Association",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.exercise11",
									"url": sap.ui.require.toUrl("sync/e08/exercise11")
								}
							}
						}
					}
