					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 4번 문제 E08",
									"targetURL": "#synce08ex4-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce08ex4-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.ex4",
									"url": sap.ui.require.toUrl("sync/e08/ex4")
								}
							}
						}
					}
