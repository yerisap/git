		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce08exercise13-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce08exercise13-display": {
								"semanticObject": "synce08exercise13",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.exercise13",
									"url": sap.ui.require.toUrl("sync/e08/exercise13")
								}
							}
						}
					}
