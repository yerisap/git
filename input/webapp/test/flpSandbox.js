		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "입력필드의 값 다뤄보기",
									"targetURL": "#synce08input-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce08input-display": {
								"semanticObject": "synce08input",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.input",
									"url": sap.ui.require.toUrl("sync/e08/input")
								}
							}
						}
					}
