		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce08exercise8-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce08exercise8-display": {
								"semanticObject": "synce08exercise8",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.exercise8",
									"url": sap.ui.require.toUrl("sync/e08/exercise8")
								}
							}
						}
					}
