		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce08exercise12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce08exercise12-display": {
								"semanticObject": "synce08exercise12",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.exercise12",
									"url": sap.ui.require.toUrl("sync/e08/exercise12")
								}
							}
						}
					}
