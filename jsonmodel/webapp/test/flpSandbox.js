		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Model 연",
									"targetURL": "#synce08jsonmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce08jsonmodel-display": {
								"semanticObject": "synce08jsonmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.jsonmodel",
									"url": sap.ui.require.toUrl("sync/e08/jsonmodel")
								}
							}
						}
					}
