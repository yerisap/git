		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제리뷰 e08",
									"targetURL": "#synce08ex3review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce08ex3review-display": {
								"semanticObject": "synce08ex3review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.ex3review",
									"url": sap.ui.require.toUrl("sync/e08/ex3review")
								}
							}
						}
					}
