					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 1번 문제 E08",
									"targetURL": "#synce08ex1-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce08ex1-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.ex1",
									"url": sap.ui.require.toUrl("sync/e08/ex1")
								}
							}
						}
					}
