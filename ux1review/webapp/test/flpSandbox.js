		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 1번리뷰 E08 ",
									"targetURL": "#synce08ux1review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce08ux1review-display": {
								"semanticObject": "synce08ux1review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.ux1review",
									"url": sap.ui.require.toUrl("sync/e08/ux1review")
								}
							}
						}
					}
