		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제리뷰 e00",
									"targetURL": "#synce00ex2review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce00ex2review-display": {
								"semanticObject": "synce00ex2review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e00.ex2review",
									"url": sap.ui.require.toUrl("sync/e00/ex2review")
								}
							}
						}
					}
