					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제 E08",
									"targetURL": "#synce08ex2-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce08ex2-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e08.ex2",
									"url": sap.ui.require.toUrl("sync/e08/ex2")
								}
							}
						}
					}
