		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce08odatamodelmultidelete-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce08odatamodelmultidelete-display": {
								"semanticObject": "synce08odatamodelmultidelete",
								"action": "display",
								"description": "다중 데이터 삭",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									"applicationType": "SAPUI5",
									"additionalInformation": "SAPUI5.Component=sync.e08.odatamodelmultidelete",
									"url": sap.ui.require.toUrl("sync/e08/odatamodelmultidelete")
								}
							}
						}
					}
